						...
						<div className="col-md-3 col-sm-12 footer-1">
							<div className="mt-20 mb-20">
								...
								<div className="box-info-contact mt-0">
									<p className="text-md neutral-400 icon-address">New Address Provided by the USER</p>
									<p className="text-md neutral-400 icon-worktime">Hours: 8:00 - 17:00, Mon - Sat</p>
									<p className="text-md neutral-400 icon-email">contact@a1carzselfdrive.com</p>
								</div>
								<div className="box-need-help">
									<p className="need-help text-md-medium mb-5">Need help? Call us</p>
									<br /><Link className="heading-6 phone-support" href="/tel:+91 9785000225">+91 9785000225</Link>
								</div>
							</div>
						</div>
					...
					<div className="footer-bottom mt-50">
						<div className="row align-items-center justify-content-center">
							<div className="col-md-6 text-md-start text-center mb-20">
								<p className="text-sm color-white"> {new Date().getFullYear()} A1Carz Inc. All rights reserved.</p>
							</div>
