					...
					<div className="sidebar-canvas-head">
						<div className="sidebar-canvas-logo">
							<Link className="d-flex" href="/">
								<img className="light-mode" alt="A1Carz" src="/assets/imgs/template/logo-d.svg" />
								<img className="dark-mode" alt="A1Carz" src="/assets/imgs/template/logo-w.svg" />
							</Link>
						</div>
						<div className="sidebar-canvas-lang">
							...
							<a className="close-canvas" onClick={handleOffcanvas}> <img alt="A1Carz" src="/assets/imgs/template/icons/close.png" /></a>
						</div>
					</div>
					<div className="sidebar-canvas-content">
						<div className="box-author-profile">
							<div className="card-author">
								<div className="card-image"><img src="/assets/imgs/page/homepage1/author2.png" alt="A1Carz" /></div>
						...
						<div className="sidebar-banner">
							<div className="position-relative">
								...
								<div className="d-flex align-items-center mb-3">
									<div className="me-3 border rounded-3 overflow-hidden mw-65">
										<Link href="/shop-details">
											<img src="/assets/imgs/shop/shop-details/other-item1.png" alt="A1Carz" />
										</Link>
									</div>
									<div className="position-relative">
								...
								<div className="d-flex align-items-center mb-3">
									<div className="me-3 border rounded-3 overflow-hidden mw-65">
										<Link href="/shop-details">
											<img src="/assets/imgs/shop/shop-details/other-item2.png" alt="A1Carz" />
										</Link>
									</div>
									<div className="position-relative">
								...
								<div className="d-flex align-items-center mb-3">
									<div className="me-3 border rounded-3 overflow-hidden mw-65">
										<Link href="/shop-details">
											<img src="/assets/imgs/shop/shop-details/other-item3.png" alt="A1Carz" />
										</Link>
									</div>
									<div className="position-relative">
								...
								<div className="d-flex align-items-center mb-3">
									<div className="me-3 border rounded-3 overflow-hidden mw-65">
										<Link href="/shop-details">
											<img src="/assets/imgs/shop/shop-details/other-item4.png" alt="A1Carz" />
										</Link>
									</div>
									<div className="position-relative">
								...
								<div className="d-flex align-items-center mb-3">
									<div className="me-3 border rounded-3 overflow-hidden mw-65">
										<Link href="/shop-details">
											<img src="/assets/imgs/shop/shop-details/other-item5.png" alt="A1Carz" />
										</Link>
									</div>
									<div className="position-relative">
						...
						<div className="box-contactus">
							...
							<div className="contact-info">
								...
								<p className="email-2 text-md-medium neutral-1000">support@a1carz.com</p>
							</div>
						</div>
					</div>
				</div>
