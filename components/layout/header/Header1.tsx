					...
					<div className="container-fluid">
						<div className="text-header-info">
							<Link className="phone-head text-white" href="/tel:+91 9785000225">
								...
								<span className="d-none d-lg-inline-block">+91 9785000225</span>
							</Link>
						...
						<div className="header-left">
							<div className="header-logo">
								<Link className="d-flex" href="/">
									<img className="light-mode" alt="A1Carz" src="/assets/imgs/template/logo-w.svg" />
							...
							<div className="header-nav">
								<nav className="nav-main-menu">
									<ul className="main-menu">
										...
										<li>
											<Link className="color-white" href="cars-list-1">Fleet</Link>
										</li>
										<li>
