				...
				<div className="top-bar top-bar-2 top-bar-3 @@bg">
					<div className="container-fluid">
						<div className="text-header-info">
							<Link className="phone-head text-white" href="/tel:+91 9785000225">
							...
							<Link className="email-head text-white" href="/tel:123-456-7890">
								...
								<span className="d-none d-lg-inline-block">contact@a1carzselfdrive.com</span>
							</Link>
						</div>
						<div className="text-header">
							<div className="text-unlock text-sm-medium text-white">Find, book and rent a <span className="text-primary">Self Drive</span>&nbsp;<span>car</span></div>
						...
						<div className="header-left">
							...
							<div className="header-nav">
								<nav className="nav-main-menu">
									<ul className="main-menu">
										<li>
											<Link className="color-black" href="/">Home</Link>
										</li>
										<li>
											<Link className="color-black" href="cars-list-1">Fleet</Link>
										</li>
										<li>
											<Link className="color-black" href="/about-us">About Us</Link>
										</li>
										<li><Link className="color-black" href="/contact">Contact</Link></li>
										<li>
											<Link className="color-black" href="/faqs">FAQs</Link>
										</li>
									</ul>
								</nav>
							</div>
							<div className="header-right">
								<div className="d-none d-xxl-inline-block align-middle mr-15">
									...
									<Link className="btn btn-signin background-brand-2 text-dark" href="/cars-list-1">Book Now!</Link>
								</div>
