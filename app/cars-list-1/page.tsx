							...
							<div className="box-search-advance background-card wow fadeIn">
								<div className="box-top-search">
									<div className="right-top-search d-none d-md-flex">
										<a className="text-sm-medium need-some-help" href="/contact">Need help?</a>
									</div>
								</div>
								<HeroSearch />
							</div>
						...
						<div className="container">
							<div className="row align-items-end">
								<div className="col-md-9 mb-30 wow fadeInUp">
									<h4 className="title-svg neutral-1000 mb-15">Our Vehicle Fleet in {location}</h4>
							...
							<div className="box-content-main pt-20">
								...
								<div className="content-left order-lg-first">
									...
									<div className="sidebar-left border-1 background-body">
										<div className="box-filters-sidebar">
											<div className="block-filter border-1">
												<h6 className="text-lg-bold item-collapse neutral-1000">Popular Location</h6>
												<div className="form-group">
													<label className="text-sm-medium neutral-1000">Location</label>
													<select className="form-control">
														...
														<option value="albert-hall">Albert Hall Museum</option>
